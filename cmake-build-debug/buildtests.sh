...
then
  /Applications/CLion.app/Contents/bin/ninja/mac/aarch64/ninja $targets_to_make ${EIGEN_MAKE_ARGS}
else
  /Applications/CLion.app/Contents/bin/ninja/mac/aarch64/ninja $targets_to_make 
fi
exit $?
